...
<head>
    ...
    <title>Relátorios Visitantes</title>
    <!-- Favicon icon -->
...
?>
        ...
        <div class="card">
                            <div class="card-body">
                                <h5 class="card-title" style="text-align: center;">Criar Relátorio De Visitantes</h5>
                                <br>
                                ...
                                <?php
                                    ...
                                    if(isset($dados['id_visita'])) {
                                        $id_visita = $dados['id_visita'];
                                    }
                            ?>
                            <form action="relatorio-visitaativa.php" method="post" target="_blank">
