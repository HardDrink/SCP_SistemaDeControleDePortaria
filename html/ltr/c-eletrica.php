...
<head>
    ...
    <title>Check List Empilhadeira Elétrica</title>
    <!-- Favicon icon -->
...
?>
        ...
        <div class="card">
                            <div class="card-body">
                                <h5 class="card-title" style="text-align: center;">Controle Diário de Equipamento - Elétrica</h5>
                                <br>
                        <form method="post">
                                    ...
                                    <div class="col-lg-3">
                                        <select name="id_emp" class="select2 form-select shadow-none" style="width: 100%; height:36px;">
                                            ...
                                            <?php 
                                                ...
                                                $result2 = mysqli_query($conn, "SELECT nome_emp, id_emp FROM empilhadeiras where tipo=2 order by nome_emp asc");
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-3">
                                        <div class="form-check-inline">
                                            <input type="checkbox" class="form-check-input" id="oleo" name="oleo1">
                                    ...
                                    <div class="form-group row">
                                    <label class="col-md-3">Água Bateria:</label>
                                    <div class="col-sm-4">
                                        <div class="form-check-inline">
                                    ...
                                    <div class="form-group row">
                                    <label class="col-md-3">Óleo do Redutor:</label>
                                    <div class="col-sm-4">
                                        <div class="form-check-inline">
                                            <input type="checkbox" style="margin-left: 10px;" class="form-check-input"
                                                id="redutor" name="redutor1">
                                                <label class="form-check-label mb-0">OK</label>
                                                <input type="checkbox" style="margin-left: 10px;" class="form-check-input"
                                                id="redutor" name="redutor2">
                                            <label class="form-check-label mb-0">Vazando</label>
                                                <input type="checkbox" style="margin-left: 10px;" class="form-check-input"
                                                id="redutor" name="redutor3">
                                            <label class="form-check-label mb-0">Baixo</label>
                                ...
                                <div class="form-group row">
                                    <h5 style="text-align: center;">Rodas: </h5>
                                </div>

                                <div class="form-group row">
                                    <label class="col-md-3">Roda De Tração:</label>
                                    <div class="col-sm-5">
                                        <div class="form-check-inline">
                                            <input type="checkbox" class="form-check-input" 
                                                id="tracao" name="tracao1">
                                            <label class="form-check-label mb-0">OK</label>
                                                <input type="checkbox" style="margin-left: 10px;" class="form-check-input"
                                                id="tracao" name="tracao2">
                                            <label class="form-check-label mb-0">Com Corte</label>
                                                <input type="checkbox" style="margin-left: 10px;" class="form-check-input"
                                                id="tracao" name="tracao2">
                                            <label class="form-check-label mb-0">Rachada</label>
                                            <input type="checkbox" style="margin-left: 10px;" class="form-check-input"
                                                id="tracao" name="tracao3">
                                            <label class="form-check-label mb-0">Trepidando</label>
                                        </div>
                                        
                                    
                                    </div>
                                    <div class="form-group row">
                                    <label class="col-md-3">Roda De Carga Direita:</label>
                                    <div class="col-sm-5">
                                        <div class="form-check-inline">
                                            <input type="checkbox" class="form-check-input" style="margin-left: 5px;"
                                                id="direita" name="direita1">
                                                <label class="form-check-label mb-0">OK</label>
                                                <input type="checkbox" style="margin-left: 10px;" class="form-check-input"
                                                id="direita" name="direita2">
                                            <label class="form-check-label mb-0">Com Corte</label>
                                                <input type="checkbox" style="margin-left: 10px;" class="form-check-input"
                                                id="direita" name="direita3">
                                            <label class="form-check-label mb-0">Rachada</label>
                                            <input type="checkbox" style="margin-left: 10px;" class="form-check-input"
                                                id="direita" name="direita4">
                                            <label class="form-check-label mb-0">Trepidando</label>
                                        </div>
                                    ...
                                    <div class="form-group row">
                                    <label class="col-md-3">Roda De Carga Esquerda:</label>
                                    <div class="col-sm-5">
                                        <div class="form-check-inline">
                                            <input type="checkbox" class="form-check-input" style="margin-left: 10px;"
                                                id="esquerda" name="esquerda1">
                                                <label class="form-check-label mb-0">OK</label>
                                                <input type="checkbox" style="margin-left: 10px;" class="form-check-input"
                                                id="esquerda" name="esquerda2">
                                            <label class="form-check-label mb-0">Com Corte</label>
                                                <input type="checkbox" style="margin-left: 10px;" class="form-check-input"
                                                id="esquerda" name="esquerda3">
                                            <label class="form-check-label mb-0">Rachada</label>
                                            <input type="checkbox" style="margin-left: 10px;" class="form-check-input"
                                                id="esquerda" name="esquerda4">
                                            <label class="form-check-label mb-0">Trepidando</label>
                                        </div>
                                    ...
                                    <div class="col-sm-6">
                                        <div class="form-check-inline">
                                            <input type="checkbox" class="form-check-input" style="margin-left: -7px;"
                                                ...
                                                <input type="checkbox" style="margin-left: 53px;" class="form-check-input"
                            ...
                            <?php
                                    ...
                                    if(isset($_POST['redutor1'])){$redutor = 'OK';}
                                    else
                                        {if(isset($_POST['redutor2'])){$redutor = 'Vazando';}
                                            if(isset($_POST['redutor3'])){$redutor = 'Baixo';}}
                                    ...
                                    if(isset($_POST['tracao1'])){$tracao = 'OK';}
                                    else
                                        {if(isset($_POST['tracao1'])){$tracao = 'Com Corte';}
                                            if(isset($_POST['tracao2'])){$tracao = 'Rachada';}
                                            if(isset($_POST['tracao3'])){$tracao = 'Trepidando';}}

                                    $direita = "";

                                    if(isset($_POST['direita1'])){$direita = 'OK';}
                                    else
                                        {if(isset($_POST['direita2'])){$direita = 'Com Corte';}
                                            if(isset($_POST['direita3'])){$direita = 'Rachada';}
                                            if(isset($_POST['direita4'])){$direita = 'Trepidando';}}

                                    $esquerda = "";

                                    if(isset($_POST['esquerda1'])){$esquerda = 'OK';}
                                    else
                                        {if(isset($_POST['esquerda2'])){$esquerda = 'Com Corte';}
                                            if(isset($_POST['tesquerdo2'])){$tesquerdo = 'Rachada';}
                                            if(isset($_POST['tesquerdo3'])){$tesquerdo = 'Trepidando';}}
                                    ...
                                    if(isset($_POST['limpeza1'])){$limpeza = 'SIM';}
                                        ...
                                        $sql="INSERT INTO emp_controle (`id_emp`,`data`,`turno`,`operador`,`hori_inicio`,`hori_final`,`inicio`,`final`,`oleo`,`agua`,`redutor`,`tracao`,`direita`,`esquerda`,`limpeza`,`anormalidades`,`manutencao`)VALUES('$id_emp','$data','$turno','$operador','$hori_inicio','$hori_final','$inicio','$final','$oleo','$agua','$redutor','$tracao','$direita','$esquerda','$limpeza','$anormalidades','$manutencao') ";
