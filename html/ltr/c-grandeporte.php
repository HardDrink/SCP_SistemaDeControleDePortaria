...
<head>
    ...
    <title>Check List Empilhadeira Grande Porte</title>
    <!-- Favicon icon -->
...
?>
        ...
        <div class="card">
                            <div class="card-body">
                                <h5 class="card-title" style="text-align: center;">Controle Diário de Equipamento - Grande Porte</h5>
                                <br>
                        <form method="post">
                                    ...
                                    <div class="col-lg-3">
                                        <select name="id_emp" class="select2 form-select shadow-none" style="width: 100%; height:36px;">
                                            ...
                                            <?php 
                                                ...
                                                $result2 = mysqli_query($conn, "SELECT nome_emp, id_emp FROM empilhadeiras where tipo=3 order by nome_emp asc");
                                    ...
                                    <div class="col-sm-3">
                                        <div class="form-check-inline">
                                            <input type="checkbox" class="form-check-input" 
                                                id="hidraulico" name="hidraulico1">
                                ...
                                <div class="form-group row">
                                    <label class="col-md-4">Pneu Dianteiro Esquerdo Externo:</label>
                                    <div class="col-sm-6">
                                        <div class="form-check-inline">
                                            <input type="checkbox" class="form-check-input" 
                                                id="desquerdoe" name="desquerdoe0">
                                            <label class="form-check-label mb-0">OK</label>
                                                <input type="checkbox" style="margin-left: 10px;" class="form-check-input"
                                                id="desquerdoe" name="desquerdoe1">
                                            <label class="form-check-label mb-0">Gasto</label>
                                                <input type="checkbox" style="margin-left: 10px;" class="form-check-input"
                                                id="desquerdoe" name="desquerdoe2">
                                            <label class="form-check-label mb-0">Rachado</label>
                                            <input type="checkbox" style="margin-left: 10px;" class="form-check-input"
                                                id="desquerdoe" name="desquerdoe3">
                                    ...
                                    <div class="form-group row">
                                    <label class="col-md-4">Pneu Dianteiro Esquerdo Interno:</label>
                                    <div class="col-sm-6">
                                        <div class="form-check-inline">
                                            <input type="checkbox" class="form-check-input" style="margin-left: 7px;"
                                                id="desquerdoi" name="desquerdoi0">
                                                <label class="form-check-label mb-0">OK</label>
                                                <input type="checkbox" style="margin-left: 10px;" class="form-check-input"
                                                id="desquerdoi" name="desquerdoi1">
                                            <label class="form-check-label mb-0">Gasto</label>
                                                <input type="checkbox" style="margin-left: 10px;" class="form-check-input"
                                                id="desquerdoi" name="desquerdoi2">
                                            <label class="form-check-label mb-0">Rachado</label>
                                            <input type="checkbox" style="margin-left: 10px;" class="form-check-input"
                                                id="desquerdoi" name="desquerdoi3">
                                            <label class="form-check-label mb-0">Deformado</label>
                                        </div>
                                    ...
                                    <div class="form-group row">
                                    <label class="col-md-4">Pneu Dianteiro Direito Externo:</label>
                                    <div class="col-sm-6">
                                        <div class="form-check-inline">
                                            <input type="checkbox" class="form-check-input" style="margin-left: 13px;"
                                                id="ddireitoe" name="ddireitoe0">
                                                <label class="form-check-label mb-0" for="customControlValidation1">OK</label>
                                                <input type="checkbox" style="margin-left: 10px;" class="form-check-input"
                                                id="ddireitoe" name="ddireitoe1">
                                            <label class="form-check-label mb-0" for="customControlValidation1">Gasto</label>
                                                <input type="checkbox" style="margin-left: 10px;" class="form-check-input"
                                                id="ddireitoe" name="ddireitoe2">
                                            <label class="form-check-label mb-0" for="customControlValidation1">Rachado</label>
                                            <input type="checkbox" style="margin-left: 10px;" class="form-check-input"
                                                id="ddireitoe" name="ddireitoe3">
                                    ...
                                    <label class="col-md-4">Pneu Dianteiro Direito Interno :</label>
                                    <div class="col-sm-6">
                                        <div class="form-check-inline">
                                            <input type="checkbox" class="form-check-input" style="margin-left: 20px;"
                                                id="ddireitoi" name="ddireitoi0">
                                                <label class="form-check-label mb-0">OK</label>
                                                <input type="checkbox" style="margin-left: 10px;" class="form-check-input"
                                                id="ddireitoi" name="ddireitoi1">
                                            <label class="form-check-label mb-0">Gasto</label>
                                                <input type="checkbox" style="margin-left: 10px;" class="form-check-input"
                                                id="ddireitoi" name="ddireitoi2">
                                            <label class="form-check-label mb-0">Rachado</label>
                                            <input type="checkbox" style="margin-left: 10px;" class="form-check-input"
                                                id="ddireitoi" name="ddireitoi3">
                                            <label class="form-check-label mb-0">Deformado</label>
                                        </div>
                                    </div>
                                    ...
                                    <label class="col-md-4">Pneu Traseiro Esquerdo:</label>
                                    <div class="col-sm-6">
                                        <div class="form-check-inline">
                                            <input type="checkbox" class="form-check-input" style="margin-left: 27px;"
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <label class="col-md-4">Pneu Traseiro Direito:</label>
                                        <div class="col-sm-6">
                                            <div class="form-check-inline">
                                                <input type="checkbox" class="form-check-input" style="margin-left: 33px;"
                                    ...
                                    <div class="col-sm-6">
                                        <div class="form-check-inline">
                                            <input type="checkbox" class="form-check-input" style="margin-left: 39px;"
                                                id="limpeza" name="limpeza1">
                                                <label class="form-check-label mb-0" for="">SIM</label>
                                                <input type="checkbox" style="margin-left: 6px;" class="form-check-input"
                            ...
                            <?php
                                    ...
                                    if(isset($_POST['desquerdoe0'])){$desquerdo = 'OK';}
                                    else
                                        {if(isset($_POST['desquerdoe1'])){$desquerdo = 'Gasto';}
                                            if(isset($_POST['desquerdoe2'])){$desquerdo = 'Rachado';}
                                            if(isset($_POST['desquerdoe3'])){$desquerdo = 'Deformado';}}

                                    $desquerdoi = "";

                                    if(isset($_POST['desquerdoi0'])){$desquerdoi = 'OK';}
                                    else
                                        {if(isset($_POST['desquerdoi1'])){$desquerdoi = 'Gasto';}
                                            if(isset($_POST['desquerdoi2'])){$desquerdoi = 'Rachado';}
                                            if(isset($_POST['desquerdoi3'])){$desquerdoi = 'Deformado';}}

                                    $ddireito = "";

                                    if(isset($_POST['ddireito0'])){$ddireito = 'OK';}
                                    else
                                        {if(isset($_POST['ddireitoe1'])){$ddireito = 'Vazando';}
                                            if(isset($_POST['ddireitoe2'])){$ddireito = 'Baixo';}
                                            if(isset($_POST['ddireitoe3'])){$ddireito = 'Deformado';}}

                                    $ddireitoi = "";

                                    if(isset($_POST['ddireitoi0'])){$ddireitoi = 'OK';}
                                    else
                                        {if(isset($_POST['ddireitoi1'])){$ddireitoi = 'Vazando';}
                                            if(isset($_POST['ddireitoi2'])){$ddireitoi = 'Baixo';}
                                            if(isset($_POST['ddireitoi3'])){$ddireitoi = 'Deformado';}}
                                    ...
                                    if(isset($_POST['limpeza1'])){$limpeza = 'SIM';}
                                        ...
                                        $sql="INSERT INTO emp_controle (`id_emp`,`data`,`turno`,`operador`,`hori_inicio`,`hori_final`,`inicio`,`final`,`oleo`,`agua`,`hidraulico`,`transmissao`,`freio`,`mangueira`,`desquerdo`,`ddireito`, `desquerdoi`, `ddireitoi`,`tesquerdo`,`tdireito`,`limpeza`,`anormalidades`,`manutencao`)VALUES('$id_emp','$data','$turno','$operador','$hori_inicio','$hori_final','$inicio','$final','$oleo','$agua','$hidraulico','$transmissao','$freio','$mangueira','$desquerdo','$ddireito', '$ddireitoi', '$desquerdoi','$tesquerdo','$tdireito','$limpeza','$anormalidades','$manutencao') ";
